...
Subnature.create(:name => "Kithless", :nature_id => Nature.find_by_name("Beast"), :splat_id => Splat.find_by_name("Changeling").id)
Subnature.create(:name => "Kithless", :nature_id => Nature.find_by_name("Darkling"), :splat_id => Splat.find_by_name("Changeling").id)
Subnature.create(:name => "Kithless", :nature_id => Nature.find_by_name("Elemental"), :splat_id => Splat.find_by_name("Changeling").id)
Subnature.create(:name => "Kithless", :nature_id => Nature.find_by_name("Fairest"), :splat_id => Splat.find_by_name("Changeling").id)
Subnature.create(:name => "Kithless", :nature_id => Nature.find_by_name("Ogre"), :splat_id => Splat.find_by_name("Changeling").id)
Subnature.create(:name => "Kithless", :nature_id => Nature.find_by_name("Beast"), :splat_id => Splat.find_by_name("Wizened").id)
