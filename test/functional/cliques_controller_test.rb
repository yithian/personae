...
class CliquesControllerTest < ActionController::TestCase
  ...
  def assert_show_view
    ...
    get :show, params: {id: cliques(:one).to_param, chronicle_id: cliques(:one).chronicle}
  ...
  test 'should get index when logged in' do
    ...
    get :index, params: {chronicle_id: Chronicle.find_by_id(users(:one).selected_chronicle_id)}
    assert_response :success
    assert_not_nil assigns(:cliques)
  end
  ...
  test 'should get new' do
    ...
    get :new, params: {chronicle_id: chronicles(:one).id}
    assert_response :success
    assert_not_nil assigns(:clique)
  end

  test 'shouldn\'t get new' do
    get :new, params: {chronicle_id: chronicles(:one)}
    assert_login
  end
  ...
  test 'should create clique' do
    ...
    assert_difference('Clique.count') do
      post :create, params: {clique: { name: 'unique', chronicle_id: chronicles(:one).id }, chronicle_id: chronicles(:one)}
    end
  ...
  test 'shouldn\'t create clique' do
    assert_no_difference('Clique.count') do
      post :create, params: {clique: { name: 'unique', chronicle_id: chronicles(:one).id }, chronicle_id: cliques(:one).chronicle}
    end
  ...
  test 'should show clique as ST' do
    ...
    assert_not_nil assigns(:clique)
    get :show, params: {id: cliques(:two).to_param, chronicle_id: cliques(:one).chronicle}
    assert_response :success, @response
    assert_not_nil assigns(:clique)
  ...
  test 'should show clique as admin' do
    ...
    get :show, params: {id: cliques(:three).to_param, chronicle_id: cliques(:one).chronicle}
    assert_response :success, @response
    assert_not_nil assigns(:clique)
  end
  ...
  test 'shouldn\'t show clique' do
    ...
    get :show, params: {id: cliques(:three).to_param, chronicle_id: cliques(:three).chronicle}
  ...
  test 'should get edit' do
    ...
    get :edit, params: {id: cliques(:one).to_param, chronicle_id: cliques(:one).chronicle}
    assert_response :success, @response
    ...
    get :edit, params: {id: cliques(:three).to_param, chronicle_id: cliques(:three).chronicle}
    assert_response :success, @response
  end

  test 'shouldn\'t get edit as nobody' do
    # not logged in
    get :edit, params: {id: cliques(:two).to_param, chronicle_id: cliques(:two).chronicle}
    assert_login
  end
  ...
  test 'shouldn\'t get edit for static clique' do
    ...
    get :edit, params: {id: cliques(:Solitary).to_param, chronicle_id: cliques(:two).chronicle}
  ...
  test 'shouldn\'t put update for static clique' do
    ...
    put :update, params: {id: cliques(:Solitary).to_param, chronicle_id: cliques(:one).chronicle}
    assert_redirected_to chronicle_clique_path(chronicles(:one), cliques(:Solitary))
    assert_equal 'Access denied!', flash[:error], 'got edit for static clique'

    sign_in(users(:one))

    put :update, params: {id: cliques(:Solitary).to_param, chronicle_id: chronicles(:one)}
    assert_redirected_to chronicle_clique_path(chronicles(:one), cliques(:Solitary))
    assert_equal 'Access denied!', flash[:error], 'got edit for static clique'
  end
  ...
  test 'shouldn\'t destroy static clique' do
    ...
    assert_no_difference('Clique.count', 'destroyed static clique') do
      delete :destroy, params: {id: cliques(:Solitary).to_param, chronicle_id: cliques(:Solitary).chronicle}
    end
  ...
  test 'should update clique' do
    ...
    put :update, params: {id: cliques(:one).to_param, clique: { name: 'testee' }, chronicle_id: cliques(:one).chronicle}
    ...
    put :update, params: {id: cliques(:three).to_param, clique: { name: 'testee' }, chronicle_id: cliques(:three).chronicle}
    assert_redirected_to chronicle_clique_path(assigns(:clique).chronicle, assigns(:clique))
  ...
  test 'shouldn\'t update other users\' cliques' do
    ...
    put :update, params: {id: cliques(:two).to_param, clique: { name: 'testee' }, chronicle_id: cliques(:one).chronicle}
    assert_redirected_to chronicle_clique_path(cliques(:two).chronicle, cliques(:two))
  ...
  test 'should destroy clique' do
    ...
    assert_difference('Clique.count', -1, 'ST couldn\'t destroy clique') do
      delete :destroy, params: {id: cliques(:one).to_param, chronicle_id: cliques(:one).chronicle}
    end
    ...
    assert_difference('Clique.count', -1, 'user who owns chronicle couldn\'t destroy clique') do
      delete :destroy, params: {id: cliques(:three).to_param, chronicle_id: cliques(:three).chronicle}
    end
    assert_redirected_to chronicle_cliques_path(cliques(:three).chronicle)
    ...
    assert_difference('Clique.count', -1, 'owning user couldn\'t destroy clique') do
      delete :destroy, params: {id: cliques(:two).to_param, chronicle_id: cliques(:two).chronicle}
    end
  ...
  test 'should update members\' chronicles' do
    ...
    put :update, params: {id: cliques(:one).to_param, clique: {chronicle_id: chronicles(:two).id}, chronicle_id: cliques(:one).chronicle}
    ...
    put :update, params: {id: cliques(:two).to_param, clique: {chronicle_id: chronicles(:three).id}, chronicle_id: cliques(:one).chronicle}
